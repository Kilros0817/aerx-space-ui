import { setDirectMessages, setMessages } from '../store/slices/messagesSlice';
...
const getChat = async(caller, receiver, dispatch) => {
    const params = {
      Key: `aerx-chat between ${caller},${receiver}`,
      Bucket: "aerx-chats"
    };
    try {
        ...
        if (err) {
          ...
          // console.log("prev chats on first try.....:\n\n", prevChat);
          return prevChat;
        }
      })
    } catch (err) {
